            ...
            <div className='weatherAppContent'>
                ...
                <Form className='searchContent'>
                    <Form.Control type="text"
                        ...
                        value={city}
                        onChange={(e) => setCity(e.target.value)} className='formInput' />

                    <Form.Control type="text"
                        placeholder="Enter a country"
                        value={country}
                        onChange={(e) => setCountry(e.target.value)} className='formInput' />

                    <Button variant="secondary" size='sm' onClick={getWeatherData}>Search</Button>
                </Form>
                {weatherData && (
                    <div>
                        <div className='weatherDetails'>
                            <h3>{weatherData.name}, {weatherData.sys.country} Weather</h3>
                            <p>As of {getCurrentTime()}</p>
                            <div className='temperatureDetails'>
                                <p className='temperatureInCelsius'>{getTemperature(weatherData.main.temp)}<sup>o</sup> C</p>
                        ...
                        <div className='climateDetails'>
                            <table>
                                <tr>
                                    <th>High/Low :</th>
                                    <td>{getHighTemperature(weatherData.main.temp_max)}/{getLowTemperature(weatherData.main.temp_min)}</td>
                                </tr>
                                <tr>
                                    <th>Humidity :</th>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>{weatherData.wind.deg}<sup>o</sup> deg</td>
                                </tr>
                                <tr>
                                    <th>Sunrise :</th>
